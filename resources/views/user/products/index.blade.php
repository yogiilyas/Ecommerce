...
<div class="container">
    ...
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card">
                <div class="card-header text-center text-light" style="background-color:#4B0082">List Products</div>
                <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    <td style="text-align:center;">
                                        <form action="{{ route('user.products.destroy',$product->id) }}" method="POST">
                                            @csrf @method('DELETE')
                                            <a class="btn btn-info btn-sm" href="{{ route('user.products.show',$product->id) }}">Show</a>
                                            <a class="btn btn-primary btn-sm" href="{{ route('user.products.edit',$product->id) }}">Edit</a>
